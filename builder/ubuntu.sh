#!/bin/sh
apt-get install --no-install-recommends --yes build-essential checkinstall cmake doxygen git \
    ...
    libyaml-cpp-dev libzipios++-dev netgen netgen-headers pyside2-tools \
